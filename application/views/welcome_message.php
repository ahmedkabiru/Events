				...
				<div class="slider">
					<div class="callbacks_container">
					  	<ul class="rslides" id="slider">
							<li>
								<img src="<?php echo base_url() ?>img/1.jpg" class="img-responsive" alt="">
								<div class="caption">
							...
							<li>
								<img src="<?php echo base_url() ?>img/4.jpg" class="img-responsive" alt="">
								<div class="caption">
							...
							<li>
								<img src="<?php echo base_url() ?>img/5.jpg" class="img-responsive" alt="">
								<div class="caption">
